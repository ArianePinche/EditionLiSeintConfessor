...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:fn2="http://localhost" exclude-result-prefixes="xs tei" version="2.0">
                ...
                <xsl:for-each select="descendant::tei:placeName">
                    <xsl:element name="div">
                        <xsl:element name="div">
                            ...
                            <xsl:variable select="substring(./@ref, 2)" name="ref"/>

                            <xsl:value-of select="//tei:place/tei:placeName[@xml:id = $ref]/@ref"/>
                        ...
                        <xsl:element name="div">
                            ...
                            <xsl:element name="div">
                                ...
                                <xsl:element name="div">
                                    ...
                                    <xsl:value-of
                                        select="./text() | ./tei:choice/tei:reg/text() | ./tei:choice/tei:expan/text()"
                                    />
                                </xsl:element>
                                <xsl:element name="div">
                                    <xsl:attribute name="type">xpath</xsl:attribute>
                                    <xsl:value-of select="string-join(fn2:generateXPath(.), '/')"/>
                                </xsl:element>
                            </xsl:element>
